...
<head>
    ...
    <title>Reset Password | The Middle Man</title>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-8">
            <div class="text-center mb-7">
                <div class="w-14 h-14 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/20 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm">
                    <i class="fas fa-unlock-alt text-2xl text-primary-700 dark:text-primary-400"></i>
                </div>
                <h1 class="text-2xl font-extrabold text-gray-900 dark:text-white">Reset Password</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Choose a new password for your account</p>
            </div>
            ...
            <form action="/reset-password" method="POST" class="space-y-4">
                ...
                <?php if ($email): ?>
                    <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                        <i class="fas fa-envelope text-gray-400"></i>
                        <span>Resetting password for <strong class="text-gray-800 dark:text-gray-200"><?= htmlspecialchars($email) ?></strong></span>
                    </div>
                <?php endif; ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        <i class="fas fa-lock absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-sm"></i>
                        <input type="password" id="password_confirmation" name="password_confirmation" required placeholder="&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;" minlength="8" class="w-full pl-10 pr-10 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent dark:text-gray-200 placeholder-gray-400 transition">
